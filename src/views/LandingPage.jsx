  ...
  return (
      <div id="landingPage" className="landing-page-container">
        ...
        <section class="animation">
          ...
          <div class="third"><div>Kayne Lee</div></div>
          <div class="fourth"><div>A Web Developer</div></div>
          <div class="fifth"><div>Kayne Lee</div></div>
        </section>
        <div class="card">
          <a class="social-link1" href="https://github.com/kayne-lee" target="_blank">
          ...
          <a class="social-link2" href="https://www.linkedin.com/in/kaynelee/" target="_blank">
